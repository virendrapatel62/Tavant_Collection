...
public interface EmployeeDao extends JpaRepository<Employee, Integer> {
	...
	@Query("select count(officeCode) from employees")
	public Integer countByOfficeCode();
	
	
	@Query("select officeCode as code,  count(officeCode) as count from employees group by officeCode order by officeCode desc")
